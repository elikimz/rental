...
function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:info@propertymanagement.com?subject=New Message from ${formData.name}&body=Name: ${formData.name}%0D%0AEmail: ${formData.email}%0D%0APhone: ${formData.phone || 'N/A'}%0D%0AMessage: ${formData.message}`;
      ...
      <main className="flex-grow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            {submitted && <p className="mt-4 text-green-500">Email client opened! Send the message from there.</p>}
          </div>
